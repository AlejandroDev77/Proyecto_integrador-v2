...
export default function CartDrawer() {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div className="fixed right-0 top-0 h-full w-full max-w-md bg-white shadow-2xl z-40 flex flex-col pt-20 md:pt-24 animate-in slide-in-from-right duration-300">
        {/* Header */}
