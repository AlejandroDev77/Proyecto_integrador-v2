...
class DetalleDevolucionObserver
{
    public function created(DetalleDevolucion $model)
    {
    ...
    public function updated(DetalleDevolucion $model)
    {
        $userId = request()->header('X-USER-ID', null);
        $userId = is_numeric($userId) ? (int)$userId : null;
        $codUsu = null;
    ...
    public function deleted(DetalleDevolucion $model)
    {
        $userId = request()->header('X-USER-ID', null);
        $userId = is_numeric($userId) ? (int)$userId : null;
        $codUsu = null;
